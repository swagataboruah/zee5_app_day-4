...
import ExceptionDemo.InvalidIdLengthException;
...
public class MainDAY2 {
	...
	public static void main(String[] args) {
		...
		// NOW MAIN CONSUMES METHODS OF MOVIE THROUGH MovieService
		        //ADD
				String resultsub = service.add(movie);
				System.out.println(resultsub);
				
				//GET USER BY ID
				Movie movie3 = service.getById("AB1");
				System.out.println(movie!=null);
				
				//GET ALL USER
				Movie movie3 = service.getAll("AB1");
				System.out.println(movie!=null);
				
				//DELETE
				String resultsub1 = service.del(subscription);
				System.out.println(resultsub1);
				
				//UPDATE
				String result2 = service.update("12", subscription) {
				System.out.println(result2);   
			     }
		...
		// NOW MAIN CONSUMES METHODS OF SERIES THROUGH SeriesService
				//ADD
				String resultsub = service.add(subscription);
				System.out.println(resultsub);
